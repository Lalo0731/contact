    ...
    <div id="carousel-example-generic" class="carousel slide carousel-slider">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            @foreach($principals as $principal)
                ...
                @if($count == 0)
                    <div class="item carousel-item-four active" style="background:url({{asset('storage/uploads/'.$principal->Foto)}}) !important;background-size: cover !important; background-position: center center !important;">
                @else
                    <div class="item carousel-item-four" style="background:url({{asset('storage/uploads/'.$principal->Foto)}}) !important;background-size: cover !important; background-position: center center !important;">
                @endif
