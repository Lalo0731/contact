...
<!-- <section class="ftco-section bg-light"> -->
<section class="ftco-section cartMov bg-light" id="paquetesProductos">
    <div class="containerIMG">
        <div class="row justify-content-center pb-2 mb-1">
            <div class="col-md-7 heading-section text_center animate__animated animate__backInLeft view_clos__paqt">
                <h2>Paquetes de <span class="bold_movil__mifi">Internet Móvil MIFI</span></h2>
                <p class="color-texto__planes">Contrata el paquete que más te guste y disfruta de esta nueva experiencia.</p>
            </div>
            <div class="col-md-7 heading-section text_center animate__animated animate__backInLeft view_clos__pagoAnticipado">
                <h2>Planes de <span class="bold_movil__mifi">Telefonía Móvil</span></h2>
                <p class="color-texto__planes">Contrata el plan que más te guste y comunícate con los que más quieras.</p>
            </div>
            <div class="col-md-7 heading-section text_center animate__animated animate__backInLeft view_clos__paqt2">
                <h2>Paquetes de <span class="bold_movil__mifi">Internet FIJO HBB</span></h2>
                <p class="color-texto__planes">Contrata el paquete que más te guste y disfruta de nuestros precios de promoción.</p>
            </div>
            <div class="col-md-7 heading-section text_center animate__animated animate__backInLeft view_clos__paqt3">
                <h2>Paquetes de <span class="bold_movil__mifi">Internet FIJO HBB</span></h2>
                <p class="color-texto__planes">Contrata el paquete que más te guste y disfruta de nuestros precios de promoción.</p>
            </div>
            <div class="col-md-7 heading-section text_center animate__animated animate__backInLeft view_clos__sim">
                <h2>Paquetes de <span class="bold_movil__mifi">Telefonía Móvil</span></h2>
                <p class="color-texto__planes">Contrata el paquete que más te guste y comunicate con los que más quieres.</p>
            </div>
                    ...
                    <div class="mov_tarjet__product">
                        <ul class="navbar-nav ml-manu lat-2">
                            <li class="nav-item activa lat-3">
                                ...
                                <button class="button lat-4 selected" onclick="paqSim()">Prepago</button>
                            </li>
                            <li class="nav-item lat-3">
                                <!-- <a href='#target2' id='target2' class='target'>Target 2</a> -->
                                <button class="button lat-4 texto_pagoAnticipado" onclick="pagoAnticipado()">Pago Anticipado</button>
                            </li>
                            <li class="nav-item lat-3">
                                <!-- <a href='#target2' id='target2' class='target'>Target 2</a> -->
            ...
            <div class="row col-md-12" style="position: static; display: flex;justify-content: center;">
                <div class="col-md-4 cartMov_paauet mb-5">
                    <div style="display: flex;justify-content: center;">
                        <div class="cardWrap">
                            <div class="cardA">
                                <div class="cardBg" style="background-image: url('PaquetesHBB/prepago30.jpg"></div>
                            </div>
                        </div>
                    </div>
                    <div style="display: flex; justify-content: center;">
                        <button class="btn mifi" style=" background-color: #463E7F; color:white;"><i class="fas fa-shopping-cart"></i> Contrata</button>
                    </div>
                </div>
                <div class="col-md-4 cartMov_paauet mb-5">
                    <div style="display: flex;justify-content: center;">
                ...
                <div class="col-md-4 cartMov_paauet mb-5">
                    ...
                    <div style="display: flex; justify-content: center;">
                        <button class="btn mifi" style=" background-color: #2D404D; color:white;"><i class="fas fa-shopping-cart"></i> Contrata</button>
                    </div>
                </div>
                <div class="col-md-3 cartMov_paauet mb-5">
                    <div style="display: flex;justify-content: center;">
                        <div class="cardWrap">
                            <div class="cardA">
                                <div class="cardBg" style="background-image: url('PaquetesHBB/prepago100.jpg');"></div>
                            </div>
                        </div>
                    </div>
                    <div style="display: flex; justify-content: center;">
                        <button class="btn mifi" style=" background-color:  #0B0A21; color:white;"><i class="fas fa-shopping-cart"></i> Contrata</button>
                    </div>
                </div>
                <div class="col-md-3 cartMov_paauet mb-5">
                    <div style="display: flex;justify-content: center;">
        ...
        {{--  PAGO ANTICIPADO  --}}
        <div class="row view_clos__pagoAnticipado view_tarj_center">
            <div class="row col-md-12" style="position: static; display: flex;justify-content: center;">
                <div class="col-md-4 cartMov_paauet mb-5">
                    <div style="display: flex;justify-content: center;">
                        <div class="cardWrap">
                            <div class="cardA">
                                <div class="cardBg" style="background-image: url('PaquetesHBB/pagoAnticipado04.jpg"></div>
                ...
                <div class="col-md-4 cartMov_paauet mb-5">
                    <div style="display: flex;justify-content: center;">
                        <div class="cardWrap">
                            <div class="cardA">
                                <div class="cardBg" style="background-image: url('PaquetesHBB/pagoAnticipado03.jpg');"></div>

                            </div>
                        </div>
                    </div>
                    <div style="display: flex; justify-content: center;">
                        <button class="btn mifi" style=" background-color:  #4F72A0; color:white;"><i class="fas fa-shopping-cart"></i> Contrata</button>
                    </div>
                </div>
                <div class="col-md-4 cartMov_paauet mb-5">
                    <div style="display: flex;justify-content: center;">
                        <div class="cardWrap">
                            <div class="cardA">
                                <div class="cardBg" style="background-image: url('PaquetesHBB/pagoAnticipado01.jpg');"></div>
                            </div>
                        </div>
                    </div>
                    <div style="display: flex; justify-content: center;">
                        <button class="btn mifi" style=" background-color:  #6C7543; color:white;"><i class="fas fa-shopping-cart"></i> Contrata</button>
                    </div>
                </div>
                {{--  <div class="col-md-3 cartMov_paauet mb-5">
                    <div style="display: flex;justify-content: center;">
                        <div class="cardWrap">
                            <div class="cardA">
                                <div class="cardBg" style="background-image: url('PaquetesHBB/pagoAnticipado02.jpg');"></div>
                            </div>
                        </div>
                    </div>
                    <div style="display: flex; justify-content: center;">
                        <button class="btn mifi" style=" background-color: #1C3B66; color:white;"><i class="fas fa-shopping-cart"></i> Contrata</button>
                    </div>
                </div>  --}}
            </div>
        </div>
...
<div class="footer medios_cat medit__cart">
    <div class=" container3">
        <div class="row">
            <!-- <div class="col-md-6 col-lg-3 pl-lg-5 mb-4 mb-md-0"> -->
            <div>
                <h2 class="footer-heading footer_heading2">Medio de pago Directo</h2>
                {{--  <h2 class="footer-heading footer_heading">Medio de pago Directo</h2>  --}}
                <ul class="list-unstyled">
                    <h2 class="marck__logoIndex2">
                    {{--  <h2 class="marck__logoIndex">  --}}
                        <div>
                       ...
                       <div>
                            <img src="{{ asset('plantilla/images/Mi_altcel.png') }}" width="75px" alt="" style="margin-top: -0.11rem;
                            height: 95.5%;">
                        </div>
                      {{-- <div>
        ...
        <div class="row">
            ...
            <!-- <div class="col-md-6 col-lg-3 pl-lg-5 mb-4 mb-md-0"> -->
            <div>
                <h2 class="footer-heading footer_heading ">Medio de pago Referenciado</h2>
                <ul class="list-unstyled">
                <h2 class="marck__logoIndex">
                        <div>
