...
<section class="hero-wrap hero-wrap-2" style="background-image: url('{{asset('storage/uploads/imagenes/'.$contacts->Foto)}}');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5 mov_info__contact">
    ...
    <section class="ftco-section bg-light">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-6 text-center mb-5 comun__contact">
				...
				<div class="row justify-content-center">
					<div class="col-md-12">
						<div class="wrapper">
							<div class="row mb-5 mv_comun__cotact">
								<div class="col-md-3">
							...
							<div class="row no-gutters mov__contacto">
								<div class="col-md-7">
									<div class="contact-wrap w-100 p-md-5 p-4 bort__contact">
										<h3 class="mb-4 colr_contactn">Contáctanos</h3>
										<form method="POST" id="contactForm" name="contactForm" class="contactForm">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="label label_contct" for="name">Nombre completo</label>
														<input type="text" class="form-control" name="name" id="name" placeholder="Nombre">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label label_contct" for="name">Teléfono</label>
														<input type="text" class="form-control" name="telefono" id="telefono" placeholder="Teléfono">
													</div>
												</div>
												<div class="col-md-6"> 
													<div class="form-group">
														<label class="label label_contct" for="email">Email</label>
														<input type="email" class="form-control" name="email" id="email" placeholder="yourmail@example.com">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<label class="label label_contct" for="subject">Asunto</label>
														<input type="text" class="form-control" name="subject" id="subject" placeholder="Asunto">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<label class="label label_contct" for="#">Mensaje</label>
														<textarea name="message" class="form-control" id="message" cols="30" rows="4" placeholder="Escríbenos lo que piensas"></textarea>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<input type="button" value="Enviar" class="btn btn-primary btnEnviar__contact" id="send_mail">
								...
								<div class="col-md-5 d-flex align-items-stretch">
									<div class="info-wrap w-100 p-5 img" style="background-image: url({{asset('plantilla/images/img-contact-form.jpg')}}); border-radius: 1rem;">
				          </div>
								</div>
							</div>
						</div>
		...
		<script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAMm0OpSkOeLy1lRymCL9SX8915_OEqMrM&callback=initMap" >
</script>
<script>
	let map;
	...
	map = new google.maps.Map(document.getElementById("map"), {
		center: { lat: 16.764578, lng: -93.122795 },
		zoom: 8,
	});
	}
