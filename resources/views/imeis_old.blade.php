...
<div class="col-md-12 d-flex justify-content-center">
    ...
    <div class="content-form-page ">
        <h3>PORTAL DE VALIDACIÓN DE EQUIPOS</h3>
        ...
        <form role="form" class="form-horizontal form-without-legend" id="contactForm" name="contactForm" class="contactForm">
            <div class="form-group">
                <label class="col-lg-5 text-success" style="font-weight: 700 !important;">Puedes consultar el IMEI de tu CELULAR, dispositivo MIFI O HBB.</label>
            </div>
            <div class="form-group">
                <label class="col-lg-2 control-label text-success" style="font-weight: 700 !important;" for="imei">INGRESA TU IMEI <span class="text-danger">*</span></label>
                <div class="col-lg-3">
                    <input type="text" id="imei" name="imei" class="form-control border-roots text-dark-roots">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-5 text-success" style="font-weight: 700 !important;">SI NO CONOCES TU NÚMERO IMEI, MARCA DESDE TU CELULAR *#06#. TAMBIÉN SE PUEDE ENCONTRAR EN UNA ETIQUETA BLANCA DEBAJO DE LA BATERÍA DE TU DISPOSITIVO, SI NO ES CELULAR.</label>
            </div>
