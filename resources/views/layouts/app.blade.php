...
<head>
    ...
    <style>
        ...
        /*background-color: #a40a19; /* Color de fondo */
        ...
        .btn-flotante:hover {
        /*background-color: #f81818; /* Color de fondo al pasar el cursor */
        background-color: #E91E63D4; /* Color de fondo al pasar el cursor */
        ...
        .li-contenedor, .li-contenedor__dropdown {
            color: #000;
            display: block;
            float: left;
            padding: 1rem;
        ...
        .li-contenedor__dropdown:hover,
        .li-contenedor__dropdown:focus-within {
            background: #A40A19;
            cursor: pointer;
        }
        
        .li-contenedor__dropdown:focus-within, .navegationEnlace {
            outline: none;
        }
        ...
        .ul-contenedor li:focus-within > ul,
        .ul-contenedor li ul:hover,
        .ul-contenedor li ul:focus {
            visibility: visible;
            opacity: 1;
            display: block;
        }
        
        .ul-padre, .li-contenedor ul li {
            clear: both;
            width: 100%;
        }
        ...
        .button-dropdown .selected-dopdown{
            color: #FFFFFF;
        }
        .button-dropdown {
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light nav_bar" id="ftco-navbar">
        <a href="{{url('/my-conecta')}}" class="btn-flotante animate__animated animate__heartBeat animate__infinite" id="recargarResponse">Recarga</a>
        <div class="container container-bont">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto mov_nav__enl">
                 @guest
                    ...
                    <ul class="enlaces__mov1 ul-contenedor">
                        <li class="enlaces__mov1 nav-item  li-contenedor li-content-top {{(request () -> is ('/'))? 'active': ''}}">
                            @if(request () -> is ('/'))
                                <a href="#" class="nav-link navegationEnlace">TELEFONíA MÓVIL</a>
                                <ul class="dropdown" aria-label="submenu">
                                    <li class="li-contenedor__dropdown">
                                            <button class="button-dropdown lat-4 selected-dopdown  navegationEnlaces" onclick="paqSim()" id="prepago">Prepago</button>
                                    </li>
                                    <li class="li-contenedor__dropdown">
                                            <button class="button-dropdown lat-4 selected-dopdown navegationEnlaces" onclick="pagoAnticipado()" id="pagoAnticipado">Pago Anticipado</button>
                                    </li>
                                </ul>
                            @else
                                <a href="/#paquetesProductos" class="nav-link navegationEnlace">TELEFONíA MÓVIL</a>
                            @endif
                        </li>
                    </ul>
                    <li class="enlaces__mov1 nav-item {{(request () -> is ('imeis*'))? 'active': ''}}"><a href="{{url('/imeis')}}" class="nav-link">Valida tu IMEI</a></li>
                    <li class="enlaces__mov1 nav-item "><a target="_blank" href="https://altanredes.com/mapas/mapa.html" _target="" class="nav-link">MAPA DE COBERTURA</a></li>
                @else
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon fa fa-map"></span><span class="text">Calle 9ª Poniente Norte, No. 1120 Col. Vista Hermosa, Tuxtla Gutiérrez, Chiapas.</span></li>
                            ...
                            <li><span class="icon fa fa-envelope"></span><span class="text ml-3">Correo electrónico para la atención de requerimientos formulados por las autoridades competentes en materia de seguridad y justicia. <a href="mailto:colaboracionseguridad@altcel2.com">colaboracionseguridad@altcel2.com</a></span></li>
                        </ul>
                    </div>
                </div>
            </div>
  ...
  <script type="text/javascript">
    ...
    $(function () {
        $('#prepago').bind("click", function () {
            var dest = $("#paquetesProductos").offset().top;
            $("html, body").animate({scrollTop: dest},600);
        });
        $('#pagoAnticipado').bind("click", function () {
            var dest = $("#paquetesProductos").offset().top;
            $("html, body").animate({scrollTop: dest},600);
        });
    });
